...
void run_gem_sig_bkd(int run_number, int num_replayed) {
  ...
  T->SetBranchAddress("H.gem.trk.pTRIG_LAD2", &pTRIG_LAD2);
  ...
  TH2D *h_dTrkVert_vs_dTrkHoriz_0 =
      new TH2D("h_dTrkVert_vs_dTrkHoriz_0",
               "dTrkVert vs dTrkHoriz (0);dTrkHoriz (cm);dTrkVert (cm)", dTrk_NBINS,
               dTrk_MIN, dTrk_MAX, dTrk_NBINS, dTrk_MIN, dTrk_MAX);

  TH2D *h_dTrkVert_vs_dTrkHoriz_1 =
      new TH2D("h_dTrkVert_vs_dTrkHoriz_1",
               "dTrkVert vs dTrkHoriz (1);dTrkHoriz (cm);dTrkVert (cm)", dTrk_NBINS,
               dTrk_MIN, dTrk_MAX, dTrk_NBINS, dTrk_MIN, dTrk_MAX);

  // Create TH2D histograms for delta_pos_long vs delta_pos_trans with track cut
  TH2D *h_dTrkVert_vs_dTrkHoriz_trkCut_0 =
      new TH2D("h_dTrkVert_vs_dTrkHoriz_trkCut_0",
               "dTrkVert vs dTrkHoriz (0);dTrkHoriz (cm);dTrkVert (cm)", dTrk_NBINS,
               dTrk_MIN, dTrk_MAX, dTrk_NBINS, dTrk_MIN, dTrk_MAX);
  TH2D *h_dTrkVert_vs_dTrkHoriz_trkCut_1 =
      new TH2D("h_dTrkVert_vs_dTrkHoriz_trkCut_1",
               "dTrkVert vs dTrkHoriz (1);dTrkHoriz (cm);dTrkVert (cm)", dTrk_NBINS,
               dTrk_MIN, dTrk_MAX, dTrk_NBINS, dTrk_MIN, dTrk_MAX);
